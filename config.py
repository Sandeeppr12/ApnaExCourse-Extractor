...
# ------------------------------------------------
BOT_TOKEN = os.environ.get("8930186040:AAH9QN7h2q7TF1j28Txxatp640z2ynVio-s", "")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@courseExteractorqBot"")
BOT_TEXT = "Sandeep BHAI KA EXTRACTOR"
# ------------------------------------------------
